        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              ...
              <button style="float: right; margin: -58px 0px 0px 0px;" type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Add new Tag</button>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <!-- start form from here -->
                        <form role="form text-left" method="Post" action="/Tag" enctype="multipart/form-data">
                           @csrf
                          <div class="row">
                          <div class="col-md-6">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"> <a href=""> </a> {{$tag->name}} </h6>
                ...
                <p style="margin: 0px 0px 0px 26px; color: #252f40; font-family:sans-serif;" > You have no Tag name. Add a one and get started.</p>
